...
export function FilterForLuisData(getLuisData: any): any {
      ...
      try {
         ...
         for (let idx: number = 0; idx < entityLength; idx++) {
            ...
            if (getLuisData['entities'][idx]['type'] == number && getLuisData['entities'][idx].resolution.value < 100)
               ...
               if (valuesLength == 1) { // will be 1 when the user ask like this month and last month like that
                  ...
                  for (let itr: number = 0; itr < valuesLength; itr++) {
