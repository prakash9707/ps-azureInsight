...
import { ParsingAzureData } from "../../Services/parseDataFromAzureApi";
import * as inputOuput from "./inputOutput";
...
describe('Testing the findCost function that returns cost of azure resourcegroup', () => {
    ...
    it('should return correct output when valid input is passed', (done) => {
        ...
        expect(result).to.deep.equal(outputForFindCost);
        done();
...
describe('Testing the Usage Quantity function', () => {
    ...
    it('should return correct output when valid input is passed', (done) => {
        let result : any = azure.FindUsageQuantity(inputOuput.inputData);
        expect(result).to.deep.equal(inputOuput.usageDetailsResult);
        done();
    });
    ...
    it('should return correct property when valid input is passed', (done) => {
        ...
        expect(result).to.have.property('totalCost');
        expect(result).to.have.property('usageDate');
        done();
    });

    it('should return invalid input when invalid input is passed', (done) => {
        let result : any = azure.FindUsageQuantity(true);
        expect(result).to.equal('Invalid input');
        done();
...
describe('Testing the FindUsageQuantityForResourceType function', () => {
    ...
    it('should return correct output when valid input is passed', (done) => {
        let result : any = azure.FindUsageQuantityForResourceType(inputOuput.inputData);
        expect(result).to.deep.equal(inputOuput.usageDetailsResultForResourceType);
        done();
    });
    ...
    it('should return invalid input when invalid input is passed', (done) => {
        let result : any = azure.FindUsageQuantityForResourceType(true);
        expect(result).to.equal('Invalid input');
        done();
